...
class type ['repr] t =
  object
    ...
    (* <input attr={"val"} /> *)
    method attribute_code_value : string -> string -> 'repr
...
let attribute_code_value name value_code_block ro =
  ro#attribute_code_value name value_code_block
...
class pp =
  ...
  object
    ...
    method attribute_code_value name code_block : string =
      name ^ "={" ^ code_block ^ "}"
